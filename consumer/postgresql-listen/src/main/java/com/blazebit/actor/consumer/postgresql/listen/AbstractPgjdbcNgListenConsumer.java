...
/**
 * A consumer that makes use of PostgreSQL LISTEN/NOTIFY via the PG-JDBC-NG driver.
 *
...
public abstract class AbstractPgjdbcNgListenConsumer<T> implements Consumer<T>, Runnable {
    ...
    /**
     * Creates a consumer that makes use of PostgreSQL LISTEN/NOTIFY via the PG-JDBC-NG driver.
     *
